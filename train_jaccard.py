...
mask_dataset = np.expand_dims((np.array(mask_dataset)),3) /1.
print(image_dataset.shape)

from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(image_dataset, mask_dataset, test_size = 0.9, random_state = 0)
print('Xtrain shape:')
print(X_train.shape)
...
plt.savefig('plottesting1.png', dpi=300, bbox_inches='tight')
plt.show()
...
model.save('test_jaccard_epoch_10_data_30.hdf5')
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('plottesting2.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend()
plt.savefig('plottesting3.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('plottesting4.png', dpi=300, bbox_inches='tight')
plt.show()
