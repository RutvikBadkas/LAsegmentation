...
def createGeometryAndMesh(FILENAME):
    # Clear all models and merge an STL mesh that we would like to remesh (from
    # the parent directory):
    gmsh.clear()
    path = os.path.abspath('refine\\')
    gmsh.merge(os.path.join(path, FILENAME+'.stl'))
    ...
    angle = 90 #gmsh.onelab.getNumber('Parameters/Angle for surface detection')[0]
    ...
    gmsh.model.mesh.classifySurfaces(90 * math.pi / 180,0, math.pi)
