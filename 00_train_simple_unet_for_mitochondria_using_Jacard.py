...
X_train_quick_test, X_test_quick_test, y_train_quick_test, y_test_quick_test = train_test_split(X_train, y_train, test_size = 0.2, random_state = 0)
...
model_jacard.save('atrium_with_jacard.hdf5')
