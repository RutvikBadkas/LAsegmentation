# =================================================================================================================
# DO NOT USE THIS FILE YET. JUST STICK WITH train.py ! ============================================================
# =================================================================================================================
...
def importdata(IMAGE_DIR, MASK_DIR, SIZE):
    ...
    for i, folder_name in enumerate(images):    #Remember enumerate method adds a counter and returns the enumerate object
        ...
        #shifting and appending data augmentation-------------
        temp_image_shifted,temp_mask_shifted=datashift(image1,mask1,-40,20)
        
        temp_image_shifted = temp_image_shifted[dim1_start:dim1_end,dim2_start:dim2_end,dim3_start:dim3_end]
        temp_mask_shifted = temp_mask_shifted[dim1_start:dim1_end,dim2_start:dim2_end,dim3_start:dim3_end]

        image_dataset.append(temp_image_shifted)
        mask_dataset.append(temp_mask_shifted)
        #end---------------------------------------------------
